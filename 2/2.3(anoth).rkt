...
(define (line1 rect)
  (define p2  (make-point (x-point (cdr rect))
              (y-point (car rect))))
  (define p1 (make-point (x-point (car rect))
              (y-point (car rect))))
  (make-segment p1 p2))

(define (line2 rect)
  (define p2  (make-point (x-point (car rect))
              (y-point (cdr rect))))
  (define p1 (make-point (x-point (car rect))
              (y-point (car rect))))
  (make-segment p1 p2))
...
;(display (len (line1 rect)))
;(newline)
;(display (len (line2 rect)))
